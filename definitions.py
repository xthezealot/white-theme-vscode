...
colorPrimaryHighlight = ColorSplit("#0064ff", colorPrimary).set_alpha(
    0.15, 0.25)
...
definitions = {
    "colors": {
        ...
        ColorSplit("#ebf0f5", colorGreyLight),
